-- ==================================================
-- 20 CONSULTAS SQL AVANZADAS
-- Base de datos: gestion_alojamientos
-- Motor: PostgreSQL
-- Requisito previo: haber ejecutado 01_schema_alojamientos_turisticos.sql
-- (las consultas 01-04 dependen de que existan los 5 propietarios,
--  10 alojamientos, 10 huéspedes y 14 reservas de la base semilla)
-- ==================================================
...
-- (id_propietario = 6, el que se acaba de crear en la consulta 01)
...
-- (el nuevo alojamiento queda con id_alojamiento = 11 y el nuevo huésped con id_huesped = 11)
...
-- (la reserva recién creada queda con id_reserva = 15)
...
-- 16. AGG - Total ingresos por alojamiento (SUM)
SELECT
    a.nombre AS alojamiento,
...
-- Nota: con los datos de la base semilla ningún alojamiento supera las
-- 2 reservas, por lo que se usa el umbral ">1" para que la consulta
-- devuelva resultados demostrables. Ajustar el número según tus datos.
SELECT
    a.nombre AS alojamiento,
    COUNT(r.id_reserva) AS total_reservas
FROM alojamientos a
